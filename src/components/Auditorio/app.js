...
var CONTAINER_ID = "auditorio-container";

var videoYoutube = false;
/**
 * Path to prepend to request URLs for the scene .gltf file and the visual logic
 * .js file.
 */
var REL_URL_PREFIX = "Auditorio/";
...
function createApp() {
  ...
  var sceneURL = params.load
    ? params.load
    : "__URL__auditorio.gltf".replace("__URL__", REL_URL_PREFIX);
  if (!sceneURL) {
...
function prepareExternalInterface(app) {
  ...
  // }
  app.ExternalInterface.VideoYoutubeVerge = function (value) {
    videoYoutube = value;
    // console.log("Hello, World!");
  };
}
...
function setVideoYoutube(boolValue) {
  videoYoutube = boolValue;
}

export { createApp, CONTAINER_ID, getVideoYoutube, setVideoYoutube };
